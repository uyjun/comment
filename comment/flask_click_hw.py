...
from clickhouse_hw import Click
app = Flask(__name__)
# @app.route('/')
# def hello_world():
#     return 'Hello world'
...
@app.route("/queryhw",methods=['POST','GET'])
def query():
    # return 'hello'
    if request.method =="POST":
        ...
        # return 'success'
        return render_template("queryhw.html",results=results1)
    return render_template("queryhw.html")
# app.route("/delete")
# def delete():
